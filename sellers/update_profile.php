...
if(isset($_POST['submit']))
{
    ...
    $update_profile_name = $conn->prepare("UPDATE `sellers` SET name = ? WHERE id = ?");
    $update_profile_name->execute([$name, $seller_id]);
    ...
    else
    {
       ...
       {
          $update_admin_pass = $conn->prepare("UPDATE `sellers` SET password = ? WHERE id = ?");
          $update_admin_pass->execute([$confirm_pass, $seller_id]);
