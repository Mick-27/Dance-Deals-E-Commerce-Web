...
if(isset($_POST['add_product']))
{
    ...
    $select_products = $conn->prepare("SELECT * FROM `sellers_products` WHERE name = ?");
    ...
    else
    {
        ...
        $insert_products = $conn->prepare("INSERT INTO `sellers_products`(seller_id, name, details, price, quantity, image_01, image_02, image_03) VALUES(?,?,?,?,?,?,?,?)");
        $insert_products->execute([$seller_id, $name, $details, $price, $quantity, $image_01, $image_02, $image_03]);
...
if(isset($_GET['delete'])){
    ...
    $delete_product_image = $conn->prepare("SELECT * FROM `sellers_products` WHERE id = ?");
    $delete_product_image->execute([$delete_id]);
    $fetch_delete_image = $delete_product_image->fetch(PDO::FETCH_ASSOC);
    unlink('../uploaded_img/'.$fetch_delete_image['image_01']);
    unlink('../uploaded_img/'.$fetch_delete_image['image_02']);
    unlink('../uploaded_img/'.$fetch_delete_image['image_03']);
    $delete_product = $conn->prepare("DELETE FROM `sellers_products` WHERE id = ?");
